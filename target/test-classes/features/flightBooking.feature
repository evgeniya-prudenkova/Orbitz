@chrome
Feature: Flight Booking Functionality (Chrome)
...
#    Choose departing flight
    And select checkbox by id - true
...
#    Then verify departure airport is "John F. Kennedy Intl. (JFK)" and arrival airport is "San Francisco Intl. (SFO)" in returning section
